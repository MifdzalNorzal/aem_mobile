...
A Flutter mobile application built as a technical assessment for AEM Enersol. The app authenticates users against via a live REST API and presents an energy analytics dashboard with bar chart statistics, donut chart distribution and an employee directory
